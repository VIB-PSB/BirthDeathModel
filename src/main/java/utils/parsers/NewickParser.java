...
public class NewickParser {
	...
	// Without parentheses: (also without , and : and ; )
	...
	// WITH parentheses, without numbers: (without , and : and ; )
	...
	// w.r.t the structure of newick format: first node: left most node and so on
